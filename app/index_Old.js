        ...
        <View className="flex flex-1 h-screen w-screen pt-0" >
            ...
            >
                ...
                <ScrollView>
                    ...
                    <View className="px-3">
                        <View className="flex min-h-[30vh] p-3 bg-white dark:bg-gray-900 rounded-3xl">
                            <View className="bg-white dark:bg-gray-900 rounded-3xl">
                                {
                                    task.length > 0 ? 
                                    ...
                                    : 
                                    <View className="flex h-[30vh] items-center justify-center"><Text className="text-gray-400 uppercase">NO Task Today</Text></View>
                                }
                            </View>
                        </View>
                    </View>
                    <View>
                        <Text className="text-base font-extrabold text-white px-3 py-2 relative bottom-1">Up Coming Task</Text>
                    </View>
                    <View className="px-3">
                        <View className="flex min-h-[30vh] p-3 bg-white dark:bg-gray-900 rounded-3xl">
                            <View className="bg-white dark:bg-gray-900 rounded-3xl">
